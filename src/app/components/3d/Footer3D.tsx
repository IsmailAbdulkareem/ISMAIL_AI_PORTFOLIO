...
const Footer3D = () => {
  ...
  const services = [
    { name: 'AI-Powered Websites', icon: Sparkles },
    { name: 'Full-Stack Development', icon: Code },
    { name: 'Web Automation', icon: Zap },
  ]
      ...
      <div className="container-max px-4 relative z-10">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            >
              Full-Stack Developer specializing in <span className="text-blue-400 font-semibold">AI-powered web solutions</span>.
              I help businesses transform their online presence with modern, intelligent, and high-performance websites.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
